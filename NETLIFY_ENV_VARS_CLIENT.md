...
| 变量名 | 说明 | 示例值 |
|--------|------|--------|
| `REACT_APP_SUPABASE_URL` | 浏览器走 Cloudflare 反代（缅甸 ISP 拦截 *.supabase.co） | `https://ml-supabase-proxy.huangdelun16.workers.dev` |
...
netlify env:set REACT_APP_SUPABASE_URL "https://ml-supabase-proxy.huangdelun16.workers.dev"
