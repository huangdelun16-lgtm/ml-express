...
const Footer: React.FC = () => {
  ...
  const services = [
    ...
    { name: '铁路运输', href: '/services' },
  ];

  const contactInfo = [
    { icon: <Phone sx={{ fontSize: 20 }} />, text: '+95 1 234 5678' },
    { icon: <Email sx={{ fontSize: 20 }} />, text: 'info@mlexpress.com' },
    { icon: <LocationOn sx={{ fontSize: 20 }} />, text: '仰光市中央商务区' },
  ];
