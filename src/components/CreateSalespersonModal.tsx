            ...
            <p className="cbl-pricing-modal__sub">
              {isEditMode
                ? isEn
                  ...
                  : isEn
                    ? 'Record company salesperson info. Employee code is a global sequence: 001, 002…'
                    : '记录公司推销员信息。员工编码全公司统一编号：001、002…'}
            </p>
          </div>
          <button
            type="button"
          ...
          <form className="cbl-customer-create-form" onSubmit={(e) => void handleSubmit(e)}>
            <div className="cbl-customer-create-form__scroll">
              ...
              <label className="cbl-manual-entry-field">
                ...
                <input
                  type="text"
                  value={formatSalespersonEmployeeCodeDisplay(form.employee_code)}
                  readOnly
                  className="cbl-input-readonly"
                />
                <small className="cbl-field-hint">
                  {isEn
                    ? 'Auto: 001, 002… (company-wide, not per region)'
                    : '自动生成：001、002…（全公司统一编号，不按区域重置）'}
                </small>
              </label>
