...
将下载的文件重命名为与 SQL 一致，例如：`ml-client-2.6.0-67.apk`

### 2. 上传到 Supabase Storage

Dashboard → **Storage → client-releases → Upload file**

- 路径：桶根目录，文件名 **`ml-client-2.6.0-67.apk`**（与下面 SQL 完全一致）
- 上传后点文件 → **Get URL**，应类似：

```
https://uopkyuluxnrewvlmutam.supabase.co/storage/v1/object/public/client-releases/ml-client-2.6.0-67.apk
```
