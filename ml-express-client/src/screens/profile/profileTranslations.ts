export const profileTranslations = {
    zh: {
      ...
      continueDelete: '继续注销',
      confirmDeleteAgainTitle: '再次确认注销',
      confirmDeleteAgain: '此操作不可撤销。请再次确认要永久注销账号。',
      deleteSuccess: '账号已注销',
      deleteFailed: '注销账号失败',
    ...
    en: {
      ...
      confirmDeleteAgainTitle: 'Confirm again',
      confirmDeleteAgain: 'This cannot be undone. Please confirm again that you want to permanently delete your account.',
    ...
    my: {
      ...
      continueDelete: 'ဆက်လက်ဖျက်သိမ်းရန်',
      confirmDeleteAgainTitle: 'ထပ်မံအတည်ပြုပါ',
      confirmDeleteAgain: 'ဤလုပ်ဆောင်ချက်ကို ပြန်လည်ပြင်ဆင်၍မရပါ။ အကောင့်ကို အမြဲတမ်းဖျက်သိမ်းရန် ထပ်မံအတည်ပြုပါ။',
      ...
      languageSwitched: 'မြန်မာဘာသာသို့ ပြောင်းပြီးပါပြီ',
      ...
      fullName: 'အမည် / ဆိုင်အမည်',
      emailAddress: 'အီးမေးလ်',
      phoneNumber: 'ဖုန်းနံပါတ်',
      detailAddress: 'လိပ်စာအပြည့်',
