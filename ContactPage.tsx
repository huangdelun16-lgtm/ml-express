...
const ContactPage: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      content: '+95 9 123 456 789',
      subtitle: '在线咨询',
      action: 'https://wa.me/959123456789',
      actionText: '发送消息',
    },
    {
      icon: <Email sx={{ fontSize: 40, color: 'secondary.main' }} />,
      title: '邮箱地址',
      content: 'info@mlexpress.com',
      subtitle: '商务合作',
      action: 'mailto:info@mlexpress.com',
      actionText: '发送邮件',
    },
    {
  ...
  const socialMedia = [
    { name: 'Facebook', icon: <Facebook />, color: '#1877f2', url: 'https://facebook.com/mlexpress' },
    { name: 'Instagram', icon: <Instagram />, color: '#e4405f', url: 'https://instagram.com/mlexpress' },
    { name: 'WhatsApp', icon: <WhatsApp />, color: '#25d366', url: 'https://wa.me/959123456789' },
  ];
